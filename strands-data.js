...
// Spangram should contain letters from all theme words or hint at the category

var STRANDS_EPOCH = new Date(2024, 0, 1); // Strands launch date

function getStrandsPuzzleIndex() {
  var now = new Date();
